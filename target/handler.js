...
function filter(value, match) {
  ...
  return (
    (value === null || value === void 0
      ? void 0
      : value.toLowerCase().localeCompare(match.toLowerCase())) === 0
  );
}
function findByLongitudeLatitude(data, details, skip) {
  ...
  return dataToReturn.filter(
    json =>
      !lodash_1.default.isEqual(json, JsonModel_1.JsonModel.EMPTY_JSON_MODEL)
  );
}
...
function verifyByCityName(jsonModel, city) {
  ...
  if (
    filter(
      (_a = jsonModel.primary_city) === null || _a === void 0
        ? void 0
        : _a.toLowerCase(),
      city
    )
  ...
  if (jsonModel.acceptable_cities && jsonModel.unacceptable_cities) {
    return (
      jsonModel.acceptable_cities
        ...
        .includes(
          city === null || city === void 0 ? void 0 : city.toLowerCase()
        ) ||
...
function getEntryFrom(details) {
  let findByZipCode = data.find(model => {
    var _a;
    return (
      ((_a = model.zip) === null || _a === void 0
        ? void 0
        : _a.localeCompare(
            details === null || details === void 0 ? void 0 : details.zipcode
          )) === 0
    );
  });
  if (!findByZipCode) {
    console.warn(
      `No unique data found by zip code : ${
        details === null || details === void 0 ? void 0 : details.zipcode
      }`
    );
...
function fuzzySearch(details) {
  ...
  const findByFuzzySearch = [
    ...new Set([...searchByZip, ...searchByCountry, ...searchByCity])
  ];
